...
def graph_years(responses,df):
   ...
   if por_ciudades:
      ...
      if por_tipo_de_productos == False:
         ...
         downloadExcel(df_toexcel.rename(columns={"ciudad":"city"}),"results_by_year_city.xlsx")
         ...
         downloadExcel(df_toexcel.rename(columns={"ciudad":"city","producto":"product"}),"results_by_year_city_product.xlsx")                                         
      ...
      if (por_tiendas == False) and (por_tipo_de_productos == False):
         ...
         downloadExcel(df_year,"results_by_year.xlsx")
...
#            years = df_store_year.year.tolist()
         ...
         downloadExcel(df_toexcel.rename(columns={"tienda":"store"}),"results_by_year_store.xlsx")
         ...
         downloadExcel(df_toexcel.rename(columns={"producto":"product"}),"results_per_year_product.xlsx")       
      else:
